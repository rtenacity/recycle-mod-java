package net.mcreator.recyclemod;
...
import net.mcreator.recyclemod.init.RecyclemodModMenus;
...
@Mod("recyclemod")
public class RecyclemodMod {
	public static final Logger LOGGER = LogManager.getLogger(RecyclemodMod.class);
	public static final String MODID = "recyclemod";

	public RecyclemodMod(IEventBus modEventBus) {
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		RecyclemodModBlocks.REGISTRY.register(modEventBus);

		RecyclemodModItems.register(modEventBus);

		RecyclemodModVariables.ATTACHMENT_TYPES.register(modEventBus);

		RecyclemodModMenus.REGISTRY.register(modEventBus);
