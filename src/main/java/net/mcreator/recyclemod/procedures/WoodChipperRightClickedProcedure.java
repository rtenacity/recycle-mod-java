...
public class WoodChipperRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.STICK) {
			...
			world.setBlock(BlockPos.containing(x, y, z), RecyclemodModBlocks.WOOD_CHIPPER_IN_USE.get().defaultBlockState(), 3);
			RecyclemodMod.queueServerWork(20, () -> {
				world.setBlock(BlockPos.containing(x, y, z), RecyclemodModBlocks.WOOD_CHIPPER.get().defaultBlockState(), 3);
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(RecyclemodModItems.WOOD_CHIPS.get()).copy();
